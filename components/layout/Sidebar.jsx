...
import { Sparkles, Home, LayoutGrid, Image as ImageIcon, Video, Moon, CircleHelp, MoreHorizontal } from "lucide-react";

const NavItem = ({ icon: Icon, label }) => (
  <button className="flex flex-col items-center justify-center gap-1.5 w-full py-4 text-zinc-400 hover:text-zinc-50 hover:bg-zinc-900/50 transition-colors rounded-lg group">
